...
{    
    ...
    {
        manageDispenseManagersInNormalMode(myLeftHead, myUI->LEDs->leftSingleBrewLeds, TOUCH_LEFT_SINGLE_BREW, &LeftHeadDispensingMsg, &LeftHeadCancelMsg, LEFT_SIDE_RECIPE_INDEX);
        manageDispenseManagersInNormalMode(myRightSingleHead, myUI->LEDs->rightBrewLeds, TOUCH_RIGHT_BREW, &RightHeadDispensingMsg, &RightHeadCancelMsg, RIGHT_SIDE_RECIPE_INDEX);
    }
    else
    {
        manageDispenseManagersInNormalMode(myRightSingleHead, myUI->LEDs->leftSingleBrewLeds, TOUCH_LEFT_SINGLE_BREW, &SingleHeadDispensingMsg, &SingleHeadCancelMsg, RIGHT_SIDE_RECIPE_INDEX);
    }
